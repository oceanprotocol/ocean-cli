...
describe("Ocean CLI Access List", function () {
  ...
  before(async function () {
    ...
    testUser1 = new ethers.Wallet(
      "0xef4b441145c1d0f3b4bc6d61d29f5c6e502359481152f869247c7a4244d45209",
      provider,
    );
    testUser2 = new ethers.Wallet(
      "0x5d75837c166221195c8763c7f6fc5f6b8f0e8f43f9f4e0b0e7a3f7e2f9f4e3a1",
      provider,
    );
  });
  ...
  describe("Create Access List", function () {
    ...
    it("should create a new access list with initial users", async function () {
      ...
      expect(output).to.include(
        `Initial users: ${testUser1.address}, ${testUser2.address}`,
      );
    });
